package com.amzass.utils.common;
...
/**
 * Http请求工具类
 * @author <a href="mailto:nathanael4ever@gmail.com>NY</a> Oct 24, 2014 2:10:49 PM
 */
	...
	private static String getResponse(String url, boolean acceptHtml) {
		...
		try {
			...
			if (statusCode == HttpStatus.SC_OK) {
				...
				result = FAIL + Constants.COLON + statusCode + Constants.COLON + StringUtils.abbreviate(msg, Constants.MAX_MSG_LENGTH);
			}
	        EntityUtils.consume(entity);
		} catch (Exception e) {
